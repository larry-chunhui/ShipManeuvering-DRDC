...
alpha = np.deg2rad(alpha_deg)  # Angle of attack (in radians)
NACA = [int(d) for d in foil]  # NACA 4-digit designation  0012 for expample
#print(NACA)
#print(NACA[0])
#print(NACA[1])
#print(NACA[2])
...
Ni = 20             # Number of interpolation points along the foil #
Nx = 25             # Number of mesh cells along the foil  # theta direction, half top in airfoil
ND = 15             # Number of cells in the downstream direction
NT = 10             # Number of cells the transverse direction # number of girds in radius directions
...
# Values of m, p and t (0.0 0.0 0.12)
m = NACA[0]/100
p = NACA[1]/10
t = (NACA[2]*10 + NACA[3])/100
print("m=%f,p=%f,t=%f"%(m,p,t))
#print(m,p,t)
# Calculate thickness
